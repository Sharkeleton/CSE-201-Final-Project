...
public class App extends JFrame{
	 ...
	 * @throws FileNotFoundException 
	 */
	public App(User user, boolean useLog, boolean modLog, boolean adminLog) throws FileNotFoundException {
		initialize(user, useLog, modLog, adminLog);
	}
	 ...
	 * @throws FileNotFoundException 
	 */
	private void initialize(User user, boolean useLog, boolean modLog, boolean adminLog) throws FileNotFoundException {
		...
		if(adminLog) {
			...
			btnApproveMovies.addActionListener(new ActionListener()
			{
				public void actionPerformed(ActionEvent e)
				{
					try {
